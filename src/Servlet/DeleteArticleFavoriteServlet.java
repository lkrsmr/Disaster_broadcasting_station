...
@WebServlet("/DeleteArticleFavoriteServlet")
public class DeleteArticleFavoriteServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean success = articleFavoriteDao.deleteArticleFavorite(id);

        if(!success) {
            response.setHeader("favoriteMsg", "删除失败！");
