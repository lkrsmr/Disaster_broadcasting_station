    ...
    <div class="neck">
        <div class="neck-items">
            <ul>
                ...
                <!-- 现在是科普文章页，因此把active的css样式给科普文章标签 -->
                <li  class="active"><a href="articles.jsp">科普文章</a></li>
                <% if(session.getAttribute("username") != null) {%>
                <li><a href="favorites.jsp">我的收藏</a></li>
                <% } %>
...
<div class="main">
    <div class="container main-container" style="width: 600px";>
        ...
        <% ArticleDao articleDao = new ArticleDao();
            ArrayList<ArticleBean> articleList = (ArrayList<ArticleBean>) articleDao.getArticles(); %>
        <c:forEach items="<%= articleList %>" var = "article">
            ...
            <div class="newContentBox">
                ...
                <a  href="DeleteArticleFavoriteServlet?id=${article.id}&src=3">
                    <img class="favoriteIcon" src="static/images/cancel-favorite.png">
                </a>
                <%} else { //不存在，该条信息未被收藏 %>
                <a  href="AddArticleFavoriteServlet?id=${article.id}&src=3">
                    <img class="favoriteIcon" src="static/images/favorite.png">
                </a>
                <%      }
                }
